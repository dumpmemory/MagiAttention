...
num_groups = [4]
# small K block
q_block_sizes = [128, 64]
k_block_sizes = [128, 64]

swap_bwd_qk_loop_vals = [False, True]
...
attn_flops_configs = [
    Benchmark(
        ...
        x_log=False,
        line_arg="swap_bwd_qk_loop",
        line_vals=swap_bwd_qk_loop_vals,
        line_names=["Swap Bwd QK Loop: False", "Swap Bwd QK Loop: True"],
        styles=[
            ("blue", "--"),
            ("red", "-"),
        ],
        ...
        plot_name=(
            f"FFA-SwapBwdQKLoop-Compare attn_mode-{attn_mode} "
...
if __name__ == "__main__":
    out_root = gen_save_path("bench_attn_ffa_swap_bwd_qk_loop_block_sparse")
