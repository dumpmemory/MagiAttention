        ...
        for config in configs_to_test:
            ...
            try:
                ...
                if "q_block_size" in config:
                    ...
                    block_sparse = config.get("block_sparse", False)
                    ...
                    ffa_args["block_sparse"] = block_sparse
                ...
                # TODO: add swap_ab and block_sparse
...
def run_block_sparse_tests(args, common_params):
    ...
    block_sparse_options_to_test = [False]
    ...
    configs_to_test = [
        ...
        for block_sparse in block_sparse_options_to_test
