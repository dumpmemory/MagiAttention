...
def generate_ninja_build_for_op(
    ...
    system_includes = [
        ...
        jit_env.MAGI_ATTENTION_CSRC_DIR.resolve(),
    ]
    ...
    env_extra_ldflags = os.environ.get("MAGI_EXTRA_LDFLAGS")
    if env_extra_ldflags:
        try:
            ...
            print(
                f"Warning: Could not parse MAGI_EXTRA_LDFLAGS with shlex: {e}. Falling back to simple split.",
                file=sys.stderr,
            )
